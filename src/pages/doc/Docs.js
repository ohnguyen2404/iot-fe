                        ...
                        <Card bordered={false} bodyStyle={{padding: '20px'}}>
                            <div id="basics">
                                ...
                                <div className="subject-content">
                                    <div className="subject-content">
                                        <p>
                                            Ani NextJs Theme is a Server side rendering app and
                                            feature rich admin template which is clean and easy to
                                            use. Current release comes with the following features:
                                            {' '}
                                        </p>
